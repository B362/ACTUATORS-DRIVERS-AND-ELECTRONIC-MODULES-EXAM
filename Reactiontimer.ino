...
#include <math.h>
#include <stdlib.h>
#include <WString.h>                                                             // Header file made as new tab in IDE to enable passing of structs.
...
void loop()
{
  ...
  while (!digitalRead(ST)){
    delay(2);
                                                                       ...
                                                                       // While no input(no digitalRead) keep system on endless wait.
  Serial.println("Starting...");

  for (int i = 0; i < 10; i++) {                                                    // Do experiment 10 times
    delay(random(1000, 2000));                                                       // Delay a random amount of time
